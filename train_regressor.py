### Command: python train_regressor.py --num_episodes 100 --num_codewords 32
...
torch.save(regressor.state_dict(), os.path.join(models_path, 'regressor_') + str(num_codewords) + '.pt')
